...
V_clip = V_num;
V_clip(V_clip > Threshold*1.1) = nan;
...
Text3 = text(0.65,0.74,Level_2D,'$x_*^{(1)}$',PersistStandalone.font_latex14{:});

Text4 = text(0.9,0.6,Level_2D,'$x_*^{(2)}$',PersistStandalone.font_latex14{:});

Text5 = text(1.23,0.26,Level_2D,'$x_*^{(3)}$',PersistStandalone.font_latex14{:});

Dirname = '/home/ppolcz/T/Dropbox/Peti/Munka/01_PPKE_2020/Dokumentaciok/28_nonzero_attractor_actual/fig/Exported_from_Matlab';
Figname = [ Dirname filesep datestr(today,29) '-genetic_toggle_switch_min_tau' ];
